...
- [Feature](https://github.com/LeChayS/bike/tree/master?tab=readme-ov-file#features)
- [Getting Started](https://github.com/LeChayS/bike/tree/master?tab=readme-ov-file#getting-started)
- [Environment Variables](https://github.com/LeChayS/bike/tree/master?tab=readme-ov-file#environment-variables)
- [Deployment](https://github.com/LeChayS/bike/tree/master?tab=readme-ov-file#deployment)
- [Merge, Branch and Commit Rules](https://github.com/LeChayS/bike/tree/master?tab=readme-ov-file#merge-branch-and-commit-rules)
...
```bash
  git clone https://github.com/LeChayS/bike.git
```
...
```bash
"BikeConnection": "Server=(localdb)\\MSSQLLocalDB;Database=BikeDB;Trusted_Connection=True;TrustServerCertificate=True;Connection Timeout=60;Command Timeout=120;Max Pool Size=200;Min Pool Size=5;"
```
...
- `git pull origin main` to update all the newest things on *main* to local
